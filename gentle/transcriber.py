...
def do_transcription(wav_file, output_wav_file, output_file):
    # full transcription
    import json
    ...
    with gentle.resampled(wav_file, output_wav_file) as filename:
...
if __name__ == '__main__':
    ...
    do_transcription(sys.argv[1], sys.argv[2])
